  ...
  "inline-flex items-center justify-center gap-4 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      ...
      size: {
        ...
        icon: "size-9",
        iconSm:
          "!size-6 rounded-sm [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
      },
      color: {
        default:
        ...
        warning:
          "bg-warning text-white hover:bg-warning/90 focus-visible:ring-warning/20 dark:focus-visible:ring-warning/40 [&.outline]:border-warning/30 [&.outline]:bg-warning/10 [&.outline]:text-warning [&.outline]:hover:bg-warning/20 [&.ghost]:text-warning [&.ghost]:hover:bg-warning/10 [&.ghost]:bg-transparent [&.link]:text-warning [&.link]:hover:text-warning/90 [&.link]:bg-transparent",
      },
    },
    defaultVariants: {
      variant: "default",
          ...
          {loading ? (
            <>
              <Spinner
                size="sm"
                className={
                  variant === "outline" ? "text-foreground" : "text-current"
                }
              />
              {children}
            </>
