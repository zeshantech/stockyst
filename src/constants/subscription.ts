...
export const SUBSCRIPTION_PLANS: ISubscriptionPlan[] = [
  {
    ...
    features: ["Up to 100 inventory items", "1 team member", "Basic reporting", "Community support", "CSV import/export", "7 day history retention"],
  ...
  },
  {
    ...
    features: ["Unlimited inventory items", "10 team members", "Advanced reporting", "API access", "Email support", "Custom fields", "All integrations", "Barcode scanning", "Batch operations", "Priority support", "1 year history retention"],
    isPopular: true,
    buttonText: "Get Started",
    buttonColor: "default",
    stripePriceId: {
  ...
  },
  {
    ...
    features: ["Unlimited inventory items", "Unlimited team members", "Advanced reporting + custom reports", "Premium API access", "24/7 priority support", "Custom fields & workflows", "Dedicated account manager", "Advanced security features", "Multi-location management", "Custom integrations", "Unlimited history retention", "SLA guarantees"],
    isPopular: false,
