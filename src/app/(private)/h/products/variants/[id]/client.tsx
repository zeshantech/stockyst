...
export default function VariantDetailsClient({ id }: { id: string }) {
  ...
  const { data: variant, isLoading: isLoadingVariant } = useVariant(id);
  ...
  const handleSubmit = (values: VariantFormValues) => {
    ...
    router.push(`/h/products/variants/${id}`);
  };
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="rounded-lg border p-6">
          <VariantForm
            ...
            onCancel={() => router.push(`/h/products/variants/${id}`)}
      ...
      <PageHeader
        ...
        action={
          <div className="flex gap-2">
            ...
            <Button
              onClick={() =>
                router.push(`/h/products/variants/${id}?edit=true`)
              }
            >
              <IconEdit />
              Edit Variant
