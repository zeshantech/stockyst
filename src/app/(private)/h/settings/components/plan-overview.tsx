...
const currentPlan = {
  ...
  features: ["Unlimited team members", "Unlimited storage", "Unlimited API requests"],
};
...
const isLoadingUsageStats = false;

const features = ["Unlimited team members", "Unlimited storage", "Unlimited API requests"];

export function PlanOverview() {
  const [isChangingPlan, setIsChangingPlan] = useState(false);
  // const currentPlan = useBillingStore((state) => state.currentSubscription?.plan);
  // const usageStats = useBillingStore((state) => state.currentSubscription?.usageStats);
  // const isLoadingUsageStats = useBillingStore((state) => state.isLoadingUsageStats);
  // const activeSubscription = useBillingStore((state) => state.currentSubscription);
